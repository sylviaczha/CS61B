...
public class IntListExercises {
    ...
    public static boolean squarePrimes(IntList lst) {
        ...
        if (lst == null) {
            ...
            /* If the current element is prime, then currElemIsPrime is true, and the current prime element is squared.
             * and then proceed to the next element until all the elements are checked.*/
